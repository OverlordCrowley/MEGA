           ...
           <form>
               <p className={classes.title}>Вход</p>
                   <div className={classes.formBlock}>
                       ...
                       <input type="text" onBlur={e => blurHandler(e)} name='email' onChange={e => emailHandler(e)} name='email' className={classes.inputs}/>
                       {(emailDirty && emailError) && <div style={{color:"red"}}>{emailError}</div>}
                   </div>
               <div className={classes.formBlock}>
                   <label className={classes.subtitle}>Password</label>
                   <input type="password" onBlur={e => blurHandler(e)} name='pass' onChange={e => passwordHandler(e)}  name='pass' className={classes.inputs}/>
               ...
               } className={buttons['border-button'] + ' ' + classes.btn}>Войти</button>
           </form>
       </div>
